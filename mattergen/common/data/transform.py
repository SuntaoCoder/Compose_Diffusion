...
def symmetrize_lattice(sample: ChemGraph) -> ChemGraph:    # 计算晶格极分解
...
def set_chemical_system_string(sample: ChemGraph) -> ChemGraph:    # 返回一个 ChemGraph 对象，其 chemical_system 属性被设置为描述该化学图的化学式
